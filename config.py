...
parser.add_argument('--checkpoints_dir',type=str, default='PaviaU',help='结果存储地址')
...
parser.add_argument('--niter2_UNet', type=int, default=500, help='#of iter at starting learning rate 7500')
parser.add_argument('--niter_decay2_UNet', type=int, default=500, help='#of iter to linearly decay learning rate to zero')
parser.add_argument("--Rank", type=int, default=40,help='CP分解的秩')


#添加噪声
parser.add_argument('--noise', type=str, default="No", help='是否对输入的数据添加噪声：Yes ,No')
parser.add_argument('--nSNR', type=int, default=30)
...
args.expr_dir=os.path.join('Houston_TR', args.data_name+'SF'+str(args.scale_factor)+'_CPRank'+str(args.Rank)+'_noise-'+str(args.noise)+
